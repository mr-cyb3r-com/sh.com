#!/bin/bash
#WHITE EYES ATTACKER :)
#Jangan Lupa Subscribe Mr.CYB3R 027
...
echo "Tools    : Kumpulan Tools ASW $white                         " |lolcat
echo "Creadby  : Mr.CYB3R $white                                      " |lolcat
echo "Contact  : 0853xxxxxxxx   $white                             " |lolcat
echo "_____________________________________________________________"
...
6) echo "created by : Mr.CYB3R" | lolcat
exit
;;
